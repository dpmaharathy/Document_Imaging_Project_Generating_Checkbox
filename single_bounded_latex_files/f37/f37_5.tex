...
\begin{itemize}[leftmargin=*]
    ...
    \item Has been inducted and trained into the AOC holder’s operation in accordance with the holder’s operation manual \hfill \CheckBox[bordercolor = 0 0 0,  ]{Yes} \CheckBox[bordercolor = 1 1 1, ]{No}
\end{itemize}
