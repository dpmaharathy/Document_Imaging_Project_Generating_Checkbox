...
\begin{itemize}[leftmargin=*]
    ...
    \item Has a working knowledge of the AOC holder’s Operations Manual \hfill \CheckBox[bordercolor = 0 0 0,  ]{Yes} \CheckBox[bordercolor = 1 1 1, ]{No}
...
\begin{itemize}[leftmargin=*]
    \item \CheckBox[bordercolor = 1 1 1, ]{Individual(s) named in A1} 
