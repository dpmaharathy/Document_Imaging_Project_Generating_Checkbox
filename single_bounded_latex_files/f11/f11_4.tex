...
\begin{itemize}[leftmargin=*, label={}, itemsep=5pt]
    ...
    \item \textbf{Category:} 
        \begin{itemize}[label={\CheckBox[bordercolor = 1 1 1, ][checked]{}}]
            \item \CheckBox[bordercolor = 1 1 1, ]{General} \hspace{0.5cm} \CheckBox[bordercolor = 1 1 1, ]{OBC}  \hspace{0.5cm} \CheckBox[bordercolor = 0 0 0,  ]{SC}  \hspace{0.5cm} \CheckBox[bordercolor = 1 1 1, ]{ST} 
        \end{itemize}
