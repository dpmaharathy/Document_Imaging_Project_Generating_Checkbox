...
\begin{itemize}[label={}, leftmargin=*]
        \item \CheckBox[bordercolor = 1 1 1, width = 1.5 em, height = 1.5em]{\textbf{Interested candidates should send their resume and cover letter to hr@company.com}} 
        
        \item \CheckBox[bordercolor = 1 1 1, width = 1.5 em, height = 1.5em]{\textbf{Application deadline: March 31, 2024}} 
        \item \CheckBox[bordercolor = 0 0 0,  width = 1.5 em, height = 1.5em]{\textbf{Only shortlisted candidates will be contacted for interviews}} 
\end{itemize}
\end{document}
