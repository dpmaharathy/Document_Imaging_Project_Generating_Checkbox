...
\section*{Sale Period}
\begin{itemize}[label={}, leftmargin=*, itemsep=5pt]
    \item \CheckBox[bordercolor = 1 1 1, ]{ Sale starts on \underline{\hspace{3cm}} and ends on \underline{\hspace{3cm}}}
    \item \CheckBox[bordercolor = 0 0 0,  ]{Store hours: Monday to Saturday (9:00 AM to 8:00 PM), Sunday (10:00 AM to 6:00 PM)} 
\end{itemize}
