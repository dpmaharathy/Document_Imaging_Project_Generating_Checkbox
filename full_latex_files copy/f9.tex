...
\begin{enumerate}[label=\textbf{\arabic*.}, align=left, leftmargin=*]
    ...
    \begin{itemize}[label={}, leftmargin=*]
        \item  \CheckBox[][width=0.5em,height = 0.5em]{\textbf{Retirement Contributions:}}
        \item  \CheckBox[][width=0.5em,height = 0.5em]{\textbf{Health Savings Account Contributions:}}
        \item  \CheckBox[][width=0.5em,height = 0.5em]{\textbf{Education Expenses:}}
    \end{itemize}
    
    \item \textbf{Tax Credits:}
    Please indicate any tax credits you are claiming:
    \begin{itemize}[label={}, leftmargin=*]
        \item  \CheckBox[][width=0.5em,height = 0.5em]{\textbf{Child Tax Credit:}}
        \item  \CheckBox[][width=0.5em,height = 0.5em]{\textbf{Earned Income Tax Credit:}}
    \end{itemize}
    ...
    \begin{itemize}[label={}, leftmargin=*]
        \item \CheckBox[]{\textbf{I agree to the declaration above.}} 
    \end{itemize}
\end{enumerate}
\end{Form}
