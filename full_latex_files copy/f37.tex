...
\begin{itemize}[leftmargin=*]
    \item Meets the requirements of schedule 9 of Civil Aviation Regulations \hfill \CheckBox[]{Yes} \CheckBox[]{No}
    \item Has a working knowledge of the AOC holder’s Operations Manual \hfill \CheckBox[]{Yes} \CheckBox[]{No}
    \item Has been inducted and trained into the AOC holder’s operation in accordance with the holder’s operation manual \hfill \CheckBox[]{Yes} \CheckBox[]{No}
\end{itemize}

I am signing this section as either:
\begin{itemize}[leftmargin=*]
    \item \CheckBox[]{Individual(s) named in A1} 
    \item \CheckBox[]{Director(s) of the Company(s) named in A1}
\end{itemize}
